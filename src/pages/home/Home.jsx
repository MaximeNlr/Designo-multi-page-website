...
export default function Home() {
    ...
    return (
        <div>
            ...
            >
                <div className="flex flex-col items-center lg:items-start gap-4 lg:gap-10 lg:w-1/2 z-10">
                ...
                <div className="flex justify-center lg:justify-end lg:w-1/2 relative">
                    <img
                        className="w-[400px] sm:w-[500px] lg:w-[800px] xl:w-[900px] 
                            relative lg:-right-32 lg:translate-y-10"
            ...
            <div className="flex flex-col gap-20 lg:flex-row px-5 py-20 md:mx-10 lg:mx-60 lg:px-0">
                {qualities.map((item) => (
                    <div className="flex flex-col items-center md:flex-row md:gap-10 lg:gap-0 lg:flex-col">
                        <div className="bg-[url(./assets/home/desktop/bg-pattern-hero-home.svg)] bg-contain bg-center bg-no-repeat md:w-1/2">
                            <img
                                className=""
                                src={item.img}
                                alt=""
